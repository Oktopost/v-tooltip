...
var Tooltip = /*#__PURE__*/function () {
  ...
  function Tooltip(_reference, _options) {
    ...
    _options = _objectSpread$3(_objectSpread$3({}, DEFAULT_OPTIONS), _options);
  ...
  _createClass(Tooltip, [{
    ...
    value: function _ensureShown(reference, options) {
      ...
      var popperOptions = _objectSpread$3(_objectSpread$3({}, options.popperOptions), {}, {
...
function getOptions(options) {
  var result = {
    ...
    popperOptions: _objectSpread$2({}, typeof options.popperOptions !== 'undefined' ? options.popperOptions : directive.options.defaultPopperOptions),
    smartTooltip: options.smartTooltip
  };
...
function createTooltip(el, value) {
  ...
  var opts = _objectSpread$2({
    title: content
  }, getOptions(_objectSpread$2(_objectSpread$2({}, _typeof(value) === 'object' ? value : {}), {}, {
...
function bind(el, _ref) {
  ...
  if (!content || !state.enabled) {
    ...
    if (el._tooltip) {
      ...
      tooltip.setOptions(_objectSpread$2(_objectSpread$2({}, value), {}, {
        placement: getPlacement(value, modifiers)
      }));
    } else {
...
var script = {
  ...
  methods: {
    ...
    $_show: function $_show() {
      ...
      if (!this.popperInstance) {
        var popperOptions = _objectSpread$1(_objectSpread$1({}, this.popperOptions), {}, {
          placement: this.placement
        });

        popperOptions.modifiers = _objectSpread$1(_objectSpread$1({}, popperOptions.modifiers), {}, {
          arrow: _objectSpread$1(_objectSpread$1({}, popperOptions.modifiers && popperOptions.modifiers.arrow), {}, {
        ...
        if (this.offset) {
          ...
          popperOptions.modifiers.offset = _objectSpread$1(_objectSpread$1({}, popperOptions.modifiers && popperOptions.modifiers.offset), {}, {
            offset: offset
          });
        }

        if (this.boundariesElement) {
          popperOptions.modifiers.preventOverflow = _objectSpread$1(_objectSpread$1({}, popperOptions.modifiers && popperOptions.modifiers.preventOverflow), {}, {
...
function install(Vue) {
  ...
  var finalPopoverOptions = _objectSpread(_objectSpread({}, defaultOptions.popover), (options === null || options === void 0 ? void 0 : options.popover) || {});

  var finalOptions = _objectSpread(_objectSpread(_objectSpread({}, defaultOptions), options || {}), {}, {
    popover: finalPopoverOptions
  });
